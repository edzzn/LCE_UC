...
public class GestionTablas {
    ...
    public GestionTablas(String nombreTabla, ArrayList<String> campos, String campoClave, ArrayList<String> longitudCampos, ArrayList<String> camposEncriptados){
    ...
    public GestionTablas(String nombreTabla, ArrayList<String> campos, String campoClave, ArrayList<String> longitudCampos){
        this.nombreTabla = nombreTabla;
        this.campos = campos;
        this.campoClave = campoClave;
        this.longitudCampos = longitudCampos;
    ...
    //  Constructor
    public GestionTablas(String nombreTabla, String nombreCampo, String nuevoCampo){
        this.nombreTabla = nombreTabla;
    ...
    public void modificarTabla(){
        ...
        try{
            ...
            if(mod.exists())
            {
                ...
                if(this.posCampo == -1)throw new Error("ERORR: No se ha encontrado el campo que se modifiacar");
    ...
    public GestionTablas(String nombreTabla){
        this.nombreTabla = nombreTabla;
    }
    ...
    public void eliminarTabla(){
        ...
        //  Eliminar siempre y cuando este vacio
